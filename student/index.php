...
<html>
    ...
    <body>
            ...
            <div id="content">
                ...
                <h1>Welcome to NILE's crime report system <span style="color: black;">Student</span>  Page </h1>
                    <p style="margin-top: 12px;margin-left: 5em;font-weight:bolder;">Welcome, <span style="color: maroon;"><?php echo $username?></span></p>    
