...
#viewdata th,td{padding:15px;text-align:left;}
    ...
    <div id="wrap">
            <div id="header" style="background-color: skyblue;">
                <div id="logo">
                    <h1 style="text-align: center;color: white;"><span><img src="../image/school%20logo.png" alt="logo" height="100px"/></span>Abuad Computer Science Projects</h1>  
                </div>
                </div>
            <div id="menu">
                <ul>
...
<!-- end of table -->
            ...
            <div id="footer" style="background-color: skyblue; text-align: center;">
            &copy;Afe Babalola University
            </div>
        </div>
